...
import (
	...
	"github.com/GoogleCloudPlatform/gke-networking-api/client/dependantresources/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type NetworkingV1Interface interface {
	RESTClient() rest.Interface
	DependantResourcesesGetter
}
...
func (c *NetworkingV1Client) DependantResourceses(namespace string) DependantResourcesInterface {
	return newDependantResourceses(c, namespace)
}
