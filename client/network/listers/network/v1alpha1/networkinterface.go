...
type NetworkInterfaceLister interface {
	...
	List(selector labels.Selector) (ret []*networkv1alpha1.NetworkInterface, err error)
...
type networkInterfaceLister struct {
	listers.ResourceIndexer[*networkv1alpha1.NetworkInterface]
}
...
func NewNetworkInterfaceLister(indexer cache.Indexer) NetworkInterfaceLister {
	return &networkInterfaceLister{listers.New[*networkv1alpha1.NetworkInterface](indexer, networkv1alpha1.Resource("networkinterface"))}
}

// NetworkInterfaces returns an object that can list and get NetworkInterfaces.
func (s *networkInterfaceLister) NetworkInterfaces(namespace string) NetworkInterfaceNamespaceLister {
	return networkInterfaceNamespaceLister{listers.NewNamespaced[*networkv1alpha1.NetworkInterface](s.ResourceIndexer, namespace)}
}
...
type NetworkInterfaceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*networkv1alpha1.NetworkInterface, error)
