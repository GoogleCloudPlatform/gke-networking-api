...
# workspace.
mkdir -p "$GOPATH/src/github.com/GoogleCloudPlatform/gke-networking-api"
ln -s "${SCRIPT_ROOT}" "$GOPATH/src/github.com/GoogleCloudPlatform/gke-networking-api/crd"

echo "GOPATH/src/github.com/GoogleCloudPlatform/gke-networking-api/crd ${GOPATH}/src/github.com/GoogleCloudPlatform/gke-networking-api/crd"


echo "Generating network CRD clientset"
"${SCRIPT_ROOT}/hack/generate-groups.sh" all \
  github.com/GoogleCloudPlatform/gke-networking-api/crd/client/network \
  github.com/GoogleCloudPlatform/gke-networking-api/crd/apis \
  "network:v1alpha1,v1" \
  --go-header-file "${SCRIPT_ROOT}/hack/boilerplate.go.txt"

echo "Generating firewall CRD clientset"
"${SCRIPT_ROOT}/hack/generate-groups.sh" all \
  github.com/GoogleCloudPlatform/gke-networking-api/crd/client/gcpfirewall \
  github.com/GoogleCloudPlatform/gke-networking-api/crd/apis \
