		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec defines the desired state of ServiceLoadBalancerStatus. This field is currently unused.",
							Default:     map[string]interface{}{},
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status defines the observed state of ServiceLoadBalancerStatus. This field is populated by the controller with the list of GCE resources.",
							Default:     map[string]interface{}{},
...
func schema_gke_networking_api_apis_serviceloadbalancerstatus_v1_ServiceLoadBalancerStatusSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServiceLoadBalancerStatusSpec is the spec for a ServiceLoadBalancerStatus resource",
				Type:        []string{"object"},
			},
		},
	}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"gceResources": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "GceResources is a list of URLs for GCE resources provisioned and managed by the GKE controller for the referenced Service. This field is managed exclusively by the controller.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
