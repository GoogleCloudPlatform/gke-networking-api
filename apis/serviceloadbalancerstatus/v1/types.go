...
type ServiceLoadBalancerStatus struct {
	...
	Spec ServiceLoadBalancerStatusSpec `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	// Status defines the observed state of ServiceLoadBalancerStatus.
	// +optional
	Status ServiceLoadBalancerStatusStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ServiceLoadBalancerStatusSpec struct {
	...
	// +required
	ServiceRef ServiceReference `json:"serviceRef" protobuf:"bytes,1,opt,name=serviceRef"`

	// GceResources is a list of URLs for GCE resources provisioned and managed
	// by the GKE controller for the referenced Service.
	// +required
	// +listType=set
	GceResources []string `json:"gceResources" protobuf:"bytes,2,rep,name=gceResources"`
}
...
type ServiceLoadBalancerStatusList struct {
	...
	Items []ServiceLoadBalancerStatus `json:"items" protobuf:"bytes,2,rep,name=items"`
}
